...
* Windows: Just double click the exe baby. Or `./Nim.exe` from the command line.
* Linux:
...
I don't care enough to reinstall Visual Studio so the original binary is provided.
